...
<%
    ...
    if (idParam == null || idParam.trim().isEmpty()) {
        response.sendRedirect("list_student.jsp?error=Invalid student ID");
        return;
    }
    ...
    try {
        ...
        response.sendRedirect("list_student.jsp?error=Invalid ID format");
        return;
    }
...
%>
    <div class="container">
        ...
        <form action="process_edit.jsp" method="POST">
            ...
            <a href="list_student.jsp" class="btn-cancel">Cancel</a>
        </form>
    </div>
</body>
</html>
